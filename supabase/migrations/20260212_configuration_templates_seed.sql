-- Phase 6: Configuration Templates - Seed Data (Updated for Empty Industries)
-- Templates work with modules only, no industry dependency
...
SELECT 
    ...
    '{"categories": [
        ...
        {"name": "Mens Clothing", "code": "CLTH-MEN", "parentCode": "CLTH", "attributes": ["size", "color", "material"], "isActive": true},
        {"name": "Womens Clothing", "code": "CLTH-WMN", "parentCode": "CLTH", "attributes": ["size", "color", "material"], "isActive": true},
        {"name": "Childrens Clothing", "code": "CLTH-KID", "parentCode": "CLTH", "attributes": ["age", "size", "color"], "isActive": true},
...
SELECT 
    ...
    'subscriptions',
    '{"plans": [
        {"name": "Free", "price": 0, "billingCycle": "monthly", "features": ["Basic features", "1 user", "Community support", "5 projects"], "limits": {"users": 1, "storage": "1GB", "apiCalls": 1000, "projects": 5}, "isPopular": false, "trialDays": 0},
        {"name": "Starter", "price": 29, "billingCycle": "monthly", "features": ["All basic features", "5 users", "Email support", "25 projects", "Basic analytics"], "limits": {"users": 5, "storage": "10GB", "apiCalls": 10000, "projects": 25}, "isPopular": false, "trialDays": 14},
        {"name": "Professional", "price": 99, "billingCycle": "monthly", "features": ["All starter features", "25 users", "Priority support", "Unlimited projects", "Advanced analytics", "Custom integrations"], "limits": {"users": 25, "storage": "100GB", "apiCalls": 100000, "projects": -1}, "isPopular": true, "trialDays": 14},
        {"name": "Enterprise", "price": 299, "billingCycle": "monthly", "features": ["All pro features", "Unlimited users", "Dedicated support", "SLA guarantee", "Custom development", "White labeling", "Advanced security"], "limits": {"users": -1, "storage": "1TB", "apiCalls": -1, "projects": -1}, "isPopular": false, "trialDays": 30}
    ]}'::jsonb,
    true,
    10,
    '["subscription"]'::jsonb,
    '1.0'
FROM modules m
WHERE m.code = 'subscription';

COMMENT ON TABLE configuration_templates IS 'Module-specific configuration templates with 8 production templates (147 total items)';
