...
export default function AnalyticsInsightsDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("AnalyticsInsights", "Overview");
  const searchFields = getSearchFields("AnalyticsInsights");
