...
export default function ServiceCustomersDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("ServiceCustomers", "Overview");
  const searchFields = getSearchFields("ServiceCustomers");
