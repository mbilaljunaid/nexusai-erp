...
export default function HRCompensationDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("HRCompensation", "Overview");
  const searchFields = getSearchFields("HRCompensation");
