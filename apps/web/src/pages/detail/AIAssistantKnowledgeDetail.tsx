...
export default function AIAssistantKnowledgeDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("AIAssistantKnowledge", "Overview");
  const searchFields = getSearchFields("AIAssistantKnowledge");
