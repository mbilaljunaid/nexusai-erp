...
export default function ServiceSettingsDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("ServiceSettings", "Overview");
  const searchFields = getSearchFields("ServiceSettings");
