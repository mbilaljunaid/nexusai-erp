...
export default function ManufacturingWorkOrdersDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("ManufacturingWorkOrders", "Overview");
  const searchFields = getSearchFields("ManufacturingWorkOrders");
