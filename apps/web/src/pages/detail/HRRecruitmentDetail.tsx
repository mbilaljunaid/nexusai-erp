...
export default function HRRecruitmentDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("HRRecruitment", "Overview");
  const searchFields = getSearchFields("HRRecruitment");
