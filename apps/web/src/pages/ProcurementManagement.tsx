...
import { SupplierList } from "@/features/procurement/SupplierList";
  ...
  return (
    <div className="space-y-6 p-4" data-testid="procurement-management">
      ...
      <div className="flex gap-2 mb-4">
        <Button variant={view === "pos" ? "default" : "outline"} onClick={() => setView("pos")}>Purchase Orders</Button>
        <Button variant={view === "suppliers" ? "default" : "outline"} onClick={() => setView("suppliers")}>Suppliers</Button>
      </div>
