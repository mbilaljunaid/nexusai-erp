...
export const productionOrders = pgTable("production_orders", {
    ...
    quantity: integer("quantity"),
    projectId: varchar("project_id"), // PJM Integration
    taskId: varchar("task_id"),       // PJM Integration
...
export const productionTransactions = pgTable("production_transactions", {
    ...
    productId: varchar("product_id"),
    quantity: numeric("quantity", { precision: 18, scale: 4 }).notNull(),
    actualCost: numeric("actual_cost", { precision: 18, scale: 4 }), // For Project Costing
    resourceId: varchar("resource_id"), // For Labor Charging
