...
export const formMetadataRegistry: Record<string, FormMetadata> = {
  ...
  accountManagement: { id: "accountManagement", name: "Account Management", apiEndpoint: "/api/accounts", fields: [], searchFields: ["name", "status"], displayField: "name", createButtonText: "Add Account", module: "CRM", page: "/crm/accounts", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "CRM", path: "/crm" }, { label: "Accounts", path: "/crm/accounts" }] },

  budgetPlanning: { id: "budgetPlanning", name: "Budget Planning", apiEndpoint: "/api/budget", fields: [], searchFields: ["name", "period"], displayField: "name", createButtonText: "Create Budget", module: "Finance", page: "/finance/budget", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Finance", path: "/finance" }, { label: "Budget", path: "/finance/budget" }] },

  communicationHub: { id: "communicationHub", name: "Communication Hub", apiEndpoint: "/api/communication", fields: [], searchFields: ["type", "status"], displayField: "type", createButtonText: "Send Message", module: "CRM", page: "/crm/communication", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "CRM", path: "/crm" }, { label: "Communication", path: "/crm/communication" }] },

  costAnalysis: { id: "costAnalysis", name: "Cost Analysis", apiEndpoint: "/api/cost-analysis", fields: [], searchFields: ["item", "period"], displayField: "item", createButtonText: "", module: "Finance", page: "/finance/cost", allowCreate: false, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Finance", path: "/finance" }, { label: "Cost Analysis", path: "/finance/cost" }] },

  customerPortal: { id: "customerPortal", name: "Customer Portal", apiEndpoint: "/api/customer-portal", fields: [], searchFields: ["customer", "status"], displayField: "customer", createButtonText: "", module: "ServiceDesk", page: "/servicedesk/portal", allowCreate: false, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "ServiceDesk", path: "/servicedesk" }, { label: "Portal", path: "/servicedesk/portal" }] },

  cycleCountInventory: { id: "cycleCountInventory", name: "Cycle Count Inventory", apiEndpoint: "/api/cycle-count", fields: [], searchFields: ["location", "status"], displayField: "location", createButtonText: "Start Count", module: "Procurement", page: "/procurement/cycle-count", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Procurement", path: "/procurement" }, { label: "Cycle Count", path: "/procurement/cycle-count" }] },

  deliveryTracking: { id: "deliveryTracking", name: "Delivery Tracking", apiEndpoint: "/api/delivery", fields: [], searchFields: ["order", "status"], displayField: "order", createButtonText: "", module: "Operations", page: "/operations/delivery", allowCreate: false, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Operations", path: "/operations" }, { label: "Delivery", path: "/operations/delivery" }] },

  employeeDirectory: { id: "employeeDirectory", name: "Employee Directory", apiEndpoint: "/api/directory", fields: [], searchFields: ["name", "department"], displayField: "name", createButtonText: "Add Employee", module: "HR", page: "/hr/directory", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "HR", path: "/hr" }, { label: "Directory", path: "/hr/directory" }] },

  fieldServiceManagement: { id: "fieldServiceManagement", name: "Field Service Management", apiEndpoint: "/api/field-service", fields: [], searchFields: ["technician", "status"], displayField: "technician", createButtonText: "Assign Task", module: "ServiceDesk", page: "/servicedesk/field-service", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "ServiceDesk", path: "/servicedesk" }, { label: "Field Service", path: "/servicedesk/field-service" }] },

  forecastingModels: { id: "forecastingModels", name: "Forecasting Models", apiEndpoint: "/api/forecasting", fields: [], searchFields: ["name", "type"], displayField: "name", createButtonText: "", module: "Analytics", page: "/analytics/forecasting", allowCreate: false, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Analytics", path: "/analytics" }, { label: "Forecasting", path: "/analytics/forecasting" }] },

  generalLedger: { id: "generalLedger", name: "General Ledger", apiEndpoint: "/api/gl", fields: [], searchFields: ["account", "date"], displayField: "account", createButtonText: "", module: "Finance", page: "/finance/gl", allowCreate: false, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Finance", path: "/finance" }, { label: "General Ledger", path: "/finance/gl" }] },

  hazardAnalysis: { id: "hazardAnalysis", name: "Hazard Analysis", apiEndpoint: "/api/hazard", fields: [], searchFields: ["name", "severity"], displayField: "name", createButtonText: "Add Hazard", module: "Operations", page: "/operations/hazard", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Operations", path: "/operations" }, { label: "Hazard", path: "/operations/hazard" }] },

  incidentManagement: { id: "incidentManagement", name: "Incident Management", apiEndpoint: "/api/incidents", fields: [], searchFields: ["id", "status"], displayField: "id", createButtonText: "Report Incident", module: "ServiceDesk", page: "/servicedesk/incidents", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "ServiceDesk", path: "/servicedesk" }, { label: "Incidents", path: "/servicedesk/incidents" }] },

  jobScheduling: { id: "jobScheduling", name: "Job Scheduling", apiEndpoint: "/api/jobs", fields: [], searchFields: ["name", "schedule"], displayField: "name", createButtonText: "Create Job", module: "Operations", page: "/operations/jobs", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Operations", path: "/operations" }, { label: "Jobs", page: "/operations/jobs" }] },

  keyPerformanceIndicators: { id: "keyPerformanceIndicators", name: "KPIs", apiEndpoint: "/api/kpis", fields: [], searchFields: ["name", "status"], displayField: "name", createButtonText: "", module: "Analytics", page: "/analytics/kpis", allowCreate: false, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Analytics", path: "/analytics" }, { label: "KPIs", path: "/analytics/kpis" }] },

  leaveLedger: { id: "leaveLedger", name: "Leave Ledger", apiEndpoint: "/api/leave", fields: [], searchFields: ["employee", "type"], displayField: "employee", createButtonText: "Record Leave", module: "HR", page: "/hr/leave", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "HR", path: "/hr" }, { label: "Leave", path: "/hr/leave" }] },

  locationManagement: { id: "locationManagement", name: "Location Management", apiEndpoint: "/api/locations", fields: [], searchFields: ["name", "region"], displayField: "name", createButtonText: "Add Location", module: "Operations", page: "/operations/locations", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Operations", path: "/operations" }, { label: "Locations", path: "/operations/locations" }] },

  marketSegmentation: { id: "marketSegmentation", name: "Market Segmentation", apiEndpoint: "/api/segments", fields: [], searchFields: ["name", "size"], displayField: "name", createButtonText: "Create Segment", module: "Marketing", page: "/marketing/segments", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Marketing", path: "/marketing" }, { label: "Segments", path: "/marketing/segments" }] },

  nonproductionEnvironments: { id: "nonproductionEnvironments", name: "Non-Production Environments", apiEndpoint: "/api/environments", fields: [], searchFields: ["name", "status"], displayField: "name", createButtonText: "Create Environment", module: "Developer", page: "/developer/environments", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Developer", path: "/developer" }, { label: "Environments", path: "/developer/environments" }] },

  opportunityManagement: { id: "opportunityManagement", name: "Opportunity Management", apiEndpoint: "/api/opportunities", fields: [], searchFields: ["name", "stage"], displayField: "name", createButtonText: "Add Opportunity", module: "Sales", page: "/sales/opportunities", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Sales", path: "/sales" }, { label: "Opportunities", path: "/sales/opportunities" }] },

  packageTracking: { id: "packageTracking", name: "Package Tracking", apiEndpoint: "/api/packages", fields: [], searchFields: ["id", "status"], displayField: "id", createButtonText: "", module: "Operations", page: "/operations/packages", allowCreate: false, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Operations", path: "/operations" }, { label: "Packages", path: "/operations/packages" }] },

  productCatalog: { id: "productCatalog", name: "Product Catalog", apiEndpoint: "/api/products", fields: [], searchFields: ["sku", "name"], displayField: "name", createButtonText: "Add Product", module: "Sales", page: "/sales/products", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Sales", path: "/sales" }, { label: "Products", path: "/sales/products" }] },

  quoteGeneration: { id: "quoteGeneration", name: "Quote Generation", apiEndpoint: "/api/quotes", fields: [], searchFields: ["id", "customer"], displayField: "id", createButtonText: "Create Quote", module: "Sales", page: "/sales/quotes", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Sales", path: "/sales" }, { label: "Quotes", path: "/sales/quotes" }] },

  receivingManagement: { id: "receivingManagement", name: "Receiving Management", apiEndpoint: "/api/receiving", fields: [], searchFields: ["po", "status"], displayField: "po", createButtonText: "Create Receipt", module: "Procurement", page: "/procurement/receiving", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Procurement", path: "/procurement" }, { label: "Receiving", path: "/procurement/receiving" }] },

  returnProcessing: { id: "returnProcessing", name: "Return Processing", apiEndpoint: "/api/returns", fields: [], searchFields: ["id", "status"], displayField: "id", createButtonText: "Create Return", module: "Sales", page: "/sales/returns", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Sales", path: "/sales" }, { label: "Returns", path: "/sales/returns" }] },

  salesForecast: { id: "salesForecast", name: "Sales Forecast", apiEndpoint: "/api/sales-forecast", fields: [], searchFields: ["period", "region"], displayField: "period", createButtonText: "", module: "Sales", page: "/sales/forecast", allowCreate: false, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Sales", path: "/sales" }, { label: "Forecast", path: "/sales/forecast" }] },

  scheduleManagement: { id: "scheduleManagement", name: "Schedule Management", apiEndpoint: "/api/schedules", fields: [], searchFields: ["name", "date"], displayField: "name", createButtonText: "Create Schedule", module: "Operations", page: "/operations/schedules", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Operations", path: "/operations" }, { label: "Schedules", path: "/operations/schedules" }] },

  securityManagement: { id: "securityManagement", name: "Security Management", apiEndpoint: "/api/security", fields: [], searchFields: ["name", "level"], displayField: "name", createButtonText: "Add Security", module: "Admin", page: "/admin/security", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Admin", path: "/admin" }, { label: "Security", path: "/admin/security" }] },

  shiftManagement: { id: "shiftManagement", name: "Shift Management", apiEndpoint: "/api/shifts", fields: [], searchFields: ["name", "date"], displayField: "name", createButtonText: "Create Shift", module: "HR", page: "/hr/shifts", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "HR", path: "/hr" }, { label: "Shifts", path: "/hr/shifts" }] },

  slaTracking: { id: "slaTracking", name: "SLA Tracking", apiEndpoint: "/api/sla", fields: [], searchFields: ["ticket", "status"], displayField: "ticket", createButtonText: "", module: "ServiceDesk", page: "/servicedesk/sla", allowCreate: false, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "ServiceDesk", path: "/servicedesk" }, { label: "SLA", path: "/servicedesk/sla" }] },

  sourceOfSupply: { id: "sourceOfSupply", name: "Source of Supply", apiEndpoint: "/api/sources", fields: [], searchFields: ["supplier", "product"], displayField: "supplier", createButtonText: "Add Source", module: "Procurement", page: "/procurement/sources", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Procurement", path: "/procurement" }, { label: "Sources", path: "/procurement/sources" }] },

  strategicPlanning: { id: "strategicPlanning", name: "Strategic Planning", apiEndpoint: "/api/strategy", fields: [], searchFields: ["name", "year"], displayField: "name", createButtonText: "Create Plan", module: "Operations", page: "/operations/strategy", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Operations", path: "/operations" }, { label: "Strategy", path: "/operations/strategy" }] },

  subscriptionManagement: { id: "subscriptionManagement", name: "Subscription Management", apiEndpoint: "/api/subscriptions-mgmt", fields: [], searchFields: ["customer", "plan"], displayField: "customer", createButtonText: "", module: "Billing", page: "/billing/subscriptions-mgmt", allowCreate: false, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Billing", path: "/billing" }, { label: "Subscriptions", path: "/billing/subscriptions-mgmt" }] },

  supplierManagement: { id: "supplierManagement", name: "Supplier Management", apiEndpoint: "/api/suppliers", fields: [], searchFields: ["name", "status"], displayField: "name", createButtonText: "Add Supplier", module: "Procurement", page: "/procurement/suppliers", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Procurement", path: "/procurement" }, { label: "Suppliers", path: "/procurement/suppliers" }] },

  systemMetrics: { id: "systemMetrics", name: "System Metrics", apiEndpoint: "/api/metrics", fields: [], searchFields: ["metric", "value"], displayField: "metric", createButtonText: "", module: "Analytics", page: "/analytics/metrics", allowCreate: false, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Analytics", path: "/analytics" }, { label: "Metrics", path: "/analytics/metrics" }] },

  teamCollaboration: { id: "teamCollaboration", name: "Team Collaboration", apiEndpoint: "/api/team", fields: [], searchFields: ["name", "project"], displayField: "name", createButtonText: "Add Team", module: "Operations", page: "/operations/team", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Operations", path: "/operations" }, { label: "Team", path: "/operations/team" }] },

  trainingDelivery: { id: "trainingDelivery", name: "Training Delivery", apiEndpoint: "/api/training-delivery", fields: [], searchFields: ["course", "trainer"], displayField: "course", createButtonText: "Deliver Training", module: "HR", page: "/hr/training-delivery", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "HR", path: "/hr" }, { label: "Training Delivery", path: "/hr/training-delivery" }] },

  usageStatistics: { id: "usageStatistics", name: "Usage Statistics", apiEndpoint: "/api/usage", fields: [], searchFields: ["resource", "period"], displayField: "resource", createButtonText: "", module: "Analytics", page: "/analytics/usage", allowCreate: false, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Analytics", path: "/analytics" }, { label: "Usage", path: "/analytics/usage" }] },

  vendorEvaluation: { id: "vendorEvaluation", name: "Vendor Evaluation", apiEndpoint: "/api/vendor-eval", fields: [], searchFields: ["vendor", "score"], displayField: "vendor", createButtonText: "Evaluate Vendor", module: "Procurement", page: "/procurement/vendor-eval", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Procurement", path: "/procurement" }, { label: "Vendor Evaluation", path: "/procurement/vendor-eval" }] },

  versionControl: { id: "versionControl", name: "Version Control", apiEndpoint: "/api/version-control", fields: [], searchFields: ["name", "version"], displayField: "name", createButtonText: "Create Version", module: "Developer", page: "/developer/version-control", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Developer", path: "/developer" }, { label: "Version Control", path: "/developer/version-control" }] },

  wasterecoveryRecycling: { id: "wasteRecoveryRecycling", name: "Waste Recovery & Recycling", apiEndpoint: "/api/waste", fields: [], searchFields: ["type", "location"], displayField: "type", createButtonText: "Add Item", module: "Operations", page: "/operations/waste", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Operations", path: "/operations" }, { label: "Waste", path: "/operations/waste" }] },

  xrayAnalysis: { id: "xrayAnalysis", name: "X-Ray Analysis", apiEndpoint: "/api/xray", fields: [], searchFields: ["item", "status"], displayField: "item", createButtonText: "", module: "Manufacturing", page: "/manufacturing/xray", allowCreate: false, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Manufacturing", path: "/manufacturing" }, { label: "X-Ray", path: "/manufacturing/xray" }] },

  yieldManagement: { id: "yieldManagement", name: "Yield Management", apiEndpoint: "/api/yield", fields: [], searchFields: ["product", "period"], displayField: "product", createButtonText: "", module: "Manufacturing", page: "/manufacturing/yield", allowCreate: false, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Manufacturing", path: "/manufacturing" }, { label: "Yield", path: "/manufacturing/yield" }] },

  zoneManagement: { id: "zoneManagement", name: "Zone Management", apiEndpoint: "/api/zones", fields: [], searchFields: ["name", "region"], displayField: "name", createButtonText: "Add Zone", module: "Operations", page: "/operations/zones", allowCreate: true, showSearch: true, breadcrumbs: [{ label: "Dashboard", path: "/" }, { label: "Operations", path: "/operations" }, { label: "Zones", path: "/operations/zones" }] },
};
