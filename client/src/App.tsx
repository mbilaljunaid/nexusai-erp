...
const FinanceBudgetsDetail = lazy(() => import("@/pages/FinanceBudgetsDetail"));
const FinanceReportsDetail = lazy(() => import("@/pages/FinanceReportsDetail"));
const FinancePaymentsDetail = lazy(() => import("@/pages/FinancePaymentsDetail"));
const FinanceLedgerDetail = lazy(() => import("@/pages/FinanceLedgerDetail"));
const FinanceSettingsDetail = lazy(() => import("@/pages/FinanceSettingsDetail"));
const Service = lazy(() => import("@/pages/Service"));
const ServiceTicketsDetail = lazy(() => import("@/pages/ServiceTicketsDetail"));
const ServiceCustomersDetail = lazy(() => import("@/pages/ServiceCustomersDetail"));
const ServiceKnowledgeDetail = lazy(() => import("@/pages/ServiceKnowledgeDetail"));
const ServiceSLADetail = lazy(() => import("@/pages/ServiceSLADetail"));
const ServiceAnalyticsDetail = lazy(() => import("@/pages/ServiceAnalyticsDetail"));
const ServiceQueueDetail = lazy(() => import("@/pages/ServiceQueueDetail"));
const ServiceSettingsDetail = lazy(() => import("@/pages/ServiceSettingsDetail"));
