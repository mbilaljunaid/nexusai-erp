...
import { GraduationCap, ArrowLeft, BarChart3, PieChart, TrendingUp, LineChart, Table, FileText } from "lucide-react";
...
export default function TrainingGuideAnalytics() {
  ...
  const modules = [
    { icon: BarChart3, title: "Dashboard Builder", desc: "Create custom dashboards and visualizations", duration: "35 min" },
    { icon: PieChart, title: "Report Designer", desc: "Build and customize reports", duration: "40 min" },
    { icon: TrendingUp, title: "Predictive Analytics", desc: "Forecasting and trend analysis", duration: "45 min" },
    { icon: LineChart, title: "KPI Management", desc: "Define and track key performance indicators", duration: "30 min" },
    { icon: Table, title: "Data Explorer", desc: "Ad-hoc queries and data analysis", duration: "25 min" },
  ];
