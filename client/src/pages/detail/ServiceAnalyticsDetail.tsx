...
export default function ServiceAnalyticsDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("ServiceAnalytics", "Overview");
  const searchFields = getSearchFields("ServiceAnalytics");
