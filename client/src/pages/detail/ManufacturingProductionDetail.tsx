...
export default function ManufacturingProductionDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("ManufacturingProduction", "Overview");
  const searchFields = getSearchFields("ManufacturingProduction");
