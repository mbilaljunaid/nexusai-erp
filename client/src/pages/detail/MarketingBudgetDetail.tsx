...
export default function MarketingBudgetDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("MarketingBudget", "Overview");
  const searchFields = getSearchFields("MarketingBudget");
