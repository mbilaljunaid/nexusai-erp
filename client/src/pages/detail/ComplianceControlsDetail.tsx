...
export default function ComplianceControlsDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("ComplianceControls", "Overview");
  const searchFields = getSearchFields("ComplianceControls");
