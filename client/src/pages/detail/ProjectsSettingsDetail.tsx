...
export default function ProjectsSettingsDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("ProjectsSettings", "Overview");
  const searchFields = getSearchFields("ProjectsSettings");
