...
export default function ProjectsAnalyticsDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("ProjectsAnalytics", "Overview");
  const searchFields = getSearchFields("ProjectsAnalytics");
