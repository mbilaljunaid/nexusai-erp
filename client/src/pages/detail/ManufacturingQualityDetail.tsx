...
export default function ManufacturingQualityDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("ManufacturingQuality", "Overview");
  const searchFields = getSearchFields("ManufacturingQuality");
