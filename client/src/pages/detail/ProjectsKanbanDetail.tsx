...
export default function ProjectsKanbanDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("ProjectsKanban", "Overview");
  const searchFields = getSearchFields("ProjectsKanban");
