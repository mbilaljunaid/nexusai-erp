...
export default function MarketingLeadsDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("MarketingLeads", "Overview");
  const searchFields = getSearchFields("MarketingLeads");
