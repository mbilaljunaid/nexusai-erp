...
export default function CompliancePoliciesDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("CompliancePolicies", "Overview");
  const searchFields = getSearchFields("CompliancePolicies");
