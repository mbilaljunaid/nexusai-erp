...
export default function MarketingEmailDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("MarketingEmail", "Overview");
  const searchFields = getSearchFields("MarketingEmail");
