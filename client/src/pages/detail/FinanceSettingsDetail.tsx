...
export default function FinanceSettingsDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("FinanceSettings", "Overview");
  const searchFields = getSearchFields("FinanceSettings");
