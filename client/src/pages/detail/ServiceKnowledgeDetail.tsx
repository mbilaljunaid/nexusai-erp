...
export default function ServiceKnowledgeDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("ServiceKnowledge", "Overview");
  const searchFields = getSearchFields("ServiceKnowledge");
