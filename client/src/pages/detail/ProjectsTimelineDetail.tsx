...
export default function ProjectsTimelineDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("ProjectsTimeline", "Overview");
  const searchFields = getSearchFields("ProjectsTimeline");
