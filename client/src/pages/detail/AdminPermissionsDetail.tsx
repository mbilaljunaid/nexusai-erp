...
export default function AdminPermissionsDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("AdminPermissions", "Overview");
  const searchFields = getSearchFields("AdminPermissions");
