...
export default function MarketingSegmentationDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("MarketingSegmentation", "Overview");
  const searchFields = getSearchFields("MarketingSegmentation");
