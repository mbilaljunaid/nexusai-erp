...
export default function FinanceLedgerDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("FinanceLedger", "Overview");
  const searchFields = getSearchFields("FinanceLedger");
