...
export default function AccountsPayable() {
    ...
    return (
        <StandardDashboard header={headerContent}>

            <ApInvoiceCapture open={isCaptureOpen} onOpenChange={setIsCaptureOpen} />

            {/* Metric Cards - 4 columns, auto-distributed because ApMetricCards returns a Fragment of Widgets */}
            <ApMetricCards />

            {/* Main Content Tabs - Spans full width */}
