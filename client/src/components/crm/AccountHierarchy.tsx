    ...
    return (
        <Card>
            ...
            <CardContent className="space-y-8 relative">
                ...
                {parent && (
                    <div className="absolute left-8 top-16 bottom-1/2 w-0.5 bg-border -z-10" />
                )}
                ...
                {parent && (
                    <div className="relative">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="bg-muted/20 p-4 rounded-lg border border-border min-w-[300px]">
                ...
                <div className="relative pl-0">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="bg-background p-5 rounded-xl border border-primary/20 shadow-sm min-w-[320px]">
                            ...
                            {children.map((child) => (
                                <div key={child.id} className="relative pl-16">
                                    ...
                                    <div className="flex items-center gap-4 group">
                                        ...
                                        <div className="bg-muted/10 p-3 rounded-lg border border-border min-w-[280px] hover:bg-muted/20 transition-colors">
