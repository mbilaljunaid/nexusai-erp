...
export default function KanbanBoard() {
  ...
  const columnColors: Record<string, string> = {
    "Todo": "bg-gray-500/10 dark:bg-gray-900",
    "In Progress": "bg-blue-500/10 dark:bg-blue-950",
    "Review": "bg-purple-500/10 dark:bg-purple-950",
    "Done": "bg-green-500/10 dark:bg-green-950",
  };
