    ...
    >
      ...
      <Card data-testid="card-new-review">
        ...
        <CardContent className="space-y-3">
          <div className="grid grid-cols-5 gap-2">
            ...
            <Button disabled={createMutation.isPending || !newReview.productId} size="sm" data-testid="button-submit">
      ...
      <Card>
        ...
        <CardContent className="space-y-2">
          {isLoading ? <TableSkeleton rows={4} /> : reviews.length === 0 ? <p className="text-muted-foreground text-center py-4">No reviews</p> : reviews.map((r: any) => (
