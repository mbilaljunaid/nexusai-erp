            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <Card className="bg-blue-50 border-blue-100">
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-blue-900">{assets.length}</div>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="bg-purple-50 border-purple-100">
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-purple-900">{selectedAssetIds.size}</div>
                        </CardContent>
                    </Card>
                    <Card className="bg-orange-50 border-orange-100">
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-orange-900">${selectedValue.toFixed(0)}</div>
                        </CardContent>
                    </Card>
                </div>
