    ...
    <div className="space-y-6 p-4">
      ...
      <Card data-testid="card-new-issue">
        ...
        <CardContent className="space-y-3">
          ...
          <Button disabled={createMutation.isPending || !newIssue.quantity} className="w-full" data-testid="button-create-issue">
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          {isLoading ? <TableSkeleton rows={4} /> : issues.length === 0 ? <p className="text-muted-foreground text-center py-4">No issues</p> : issues.map((i: any) => (
