...
export default function OpenSourcePage() {
  ...
  return (
    <StandardPage title="NexusAIFirst is Open Source">
      <Header />
        ...
        <section className="px-4 py-20">
          <div className="max-w-4xl mx-auto text-center">
            <Card className="p-12 bg-gradient-to-br from-slate-800 to-slate-900 text-white">
              ...
              <div className="flex gap-4 justify-center flex-wrap">
                <a href="https://github.com/mbilaljunaid/nexusai-erp" target="_blank" rel="noopener noreferrer">
                  <Button size="lg" className="bg-card text-foreground dark:text-slate-200 hover:bg-slate-500/15" data-testid="button-star-github">
                ...
                <a href="https://github.com/mbilaljunaid/nexusai-erp/fork" target="_blank" rel="noopener noreferrer">
                  <Button size="lg" variant="outline" className="border-white text-white hover:bg-card/10" data-testid="button-fork-github">
