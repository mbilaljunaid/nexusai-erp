    ...
    >
      ...
      <Card data-testid="card-new-campaign">
        ...
        <CardContent className="space-y-3">
          <div className="grid grid-cols-5 gap-2">
            ...
            <Button disabled={createMutation.isPending || !newCampaign.campaignId} size="sm" data-testid="button-create">
      ...
      <Card>
        ...
        <CardContent className="space-y-2">
          {isLoading ? <TableSkeleton rows={4} /> : campaigns.length === 0 ? <p className="text-muted-foreground text-center py-4">No campaigns</p> : campaigns.map((c: any) => (
