                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            <Card className="lg:col-span-2 bg-slate-900 border-slate-800 shadow-xl">
                                <CardHeader>
                                    ...
                                    <CardDescription className="text-muted-foreground/70">Invoices bucketed by days past due</CardDescription>
                                </CardHeader>
                                <CardContent>
                            ...
                            <Card className="bg-slate-900 border-slate-800 shadow-xl">
                                <CardHeader>
                                    ...
                                    <CardDescription className="text-muted-foreground/70">Customer risk categories</CardDescription>
                                </CardHeader>
                            ...
                            <CardHeader className="bg-slate-900/50 border-b border-slate-800">
                                <div className="flex justify-between items-center">
                                    <div>
                                        ...
                                        <CardDescription className="text-muted-foreground/70">Tasks generated by the dunning engine</CardDescription>
                                    </div>
                                ...
                                <Table>
                                    <TableHeader className="bg-slate-900/50">
                                        <TableRow className="hover:bg-transparent border-slate-800">
                                            <TableHead className="text-muted-foreground/70">Customer</TableHead>
                                            <TableHead className="text-muted-foreground/70">Task Type</TableHead>
                                            <TableHead className="text-muted-foreground/70">Priority</TableHead>
                                            <TableHead className="text-muted-foreground/70">Status</TableHead>
                                            <TableHead className="text-muted-foreground/70 text-right">Actions</TableHead>
                                        </TableRow>
                                    </TableHeader>
                                    <TableBody>
                                        {safeTasks.map((task: any) => (
                                            <TableRow key={task.id} className="border-slate-800 hover:bg-slate-800/50 transition-colors">
                                                ...
                                                <TableCell>
                                                    <span className="text-muted-foreground/70 text-sm italic">{task.status}</span>
                                                </TableCell>
                                                <TableCell className="text-right">
                                                    ...
                                                    <Button size="sm" variant="ghost" className="text-muted-foreground/70">
                                                        Resolve
                                                    </Button>
                                                </TableCell>
                                            </TableRow>
                    ...
                    <TabsContent value="history">
                        <Card className="bg-slate-900 border-slate-800 shadow-xl">
                            <CardHeader>
                                ...
                                <CardDescription className="text-muted-foreground/70">Historical records of automated collections runs</CardDescription>
                            </CardHeader>
                            <CardContent>
                                <Table>
                                    <TableHeader>
                                        <TableRow className="border-slate-800">
                                            ...
                                            <TableHead className="text-muted-foreground/70">Invoices Processed</TableHead>
                                            <TableHead className="text-muted-foreground/70">Tasks Generated</TableHead>
                                            <TableHead className="text-muted-foreground/70">Status</TableHead>
                                        </TableRow>
                                    </TableHeader>
                                    <TableBody>
