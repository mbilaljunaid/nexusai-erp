        ...
        >
            ...
            <Pagination className="mt-4">
                <PaginationContent>
                    ...
                    <PaginationItem>
                        <span className="text-sm font-medium mx-4">Page {page} of {meta?.totalPages || 1}</span>
                    </PaginationItem>
                    <PaginationItem>
                        <PaginationNext
                            onClick={() => setPage(p => p + 1)}
                            className={page === (meta?.totalPages || 1) ? "pointer-events-none opacity-50" : "cursor-pointer"}
                        />
                    </PaginationItem>
                </PaginationContent>
            </Pagination>
