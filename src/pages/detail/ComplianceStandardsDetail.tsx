...
export default function ComplianceStandardsDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("ComplianceStandards", "Overview");
  const searchFields = getSearchFields("ComplianceStandards");
