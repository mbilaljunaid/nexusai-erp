...
export default function HRPerformanceDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("HRPerformance", "Overview");
  const searchFields = getSearchFields("HRPerformance");
