...
export default function AnalyticsReportsDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("AnalyticsReports", "Overview");
  const searchFields = getSearchFields("AnalyticsReports");
