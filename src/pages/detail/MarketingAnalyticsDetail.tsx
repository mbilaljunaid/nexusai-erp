...
export default function MarketingAnalyticsDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("MarketingAnalytics", "Overview");
  const searchFields = getSearchFields("MarketingAnalytics");
