...
export default function AIAssistantChatDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("AIAssistantChat", "Overview");
  const searchFields = getSearchFields("AIAssistantChat");
