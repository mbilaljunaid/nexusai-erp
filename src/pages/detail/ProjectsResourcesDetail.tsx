...
export default function ProjectsResourcesDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("ProjectsResources", "Overview");
  const searchFields = getSearchFields("ProjectsResources");
