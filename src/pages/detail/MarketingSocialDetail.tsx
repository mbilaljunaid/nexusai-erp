...
export default function MarketingSocialDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("MarketingSocial", "Overview");
  const searchFields = getSearchFields("MarketingSocial");
