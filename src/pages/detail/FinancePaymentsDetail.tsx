...
export default function FinancePaymentsDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("FinancePayments", "Overview");
  const searchFields = getSearchFields("FinancePayments");
