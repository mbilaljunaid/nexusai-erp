...
export default function MarketingSettingsDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("MarketingSettings", "Overview");
  const searchFields = getSearchFields("MarketingSettings");
