...
export default function AnalyticsDashboardDetail() {
  ...
  const breadcrumbs = generateBreadcrumbs("AnalyticsDashboard", "Overview");
  const searchFields = getSearchFields("AnalyticsDashboard");
