      ...
      <div className="grid grid-cols-4 gap-3">
        ...
        <Card className="p-3">
          <CardContent className="pt-0">
            ...
            <p className="text-2xl font-bold text-muted-foreground">{promos.length - active}</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card data-testid="card-new-promo">
        ...
        <CardContent className="space-y-3">
          <div className="grid grid-cols-5 gap-2">
            ...
            <Button disabled={createMutation.isPending || !newPromo.code} size="sm" data-testid="button-create-promo">
