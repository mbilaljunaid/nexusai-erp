    ...
    >
      ...
      <Card data-testid="card-new-test">
        ...
        <CardContent className="space-y-3">
          <div className="grid grid-cols-5 gap-2">
            ...
            <Button disabled={createMutation.isPending || !newTest.sampleId} size="sm" data-testid="button-create-test">
      ...
      <Card>
        ...
        <CardContent className="space-y-2">
          {isLoading ? <TableSkeleton rows={4} /> : tests.length === 0 ? <p className="text-muted-foreground text-center py-4">No tests</p> : tests.map((t: any) => (
