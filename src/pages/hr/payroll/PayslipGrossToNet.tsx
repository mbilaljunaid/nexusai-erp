                        ...
                        <Card className="border-zinc-200/50 dark:border-zinc-800/50 shadow-sm">
                            ...
                            <CardContent className="p-0">
                                ...
                                <div className="border-b group">
                                    <div className="px-6 py-3 flex items-center justify-between cursor-pointer hover:bg-zinc-50 dark:hover:bg-zinc-900/50 transition-colors" onClick={() => toggleSection('earnings')}>
                                ...
                                {/* Pre-Tax Deductions */}
                                <div className="border-b group">
                                    <div className="px-6 py-3 flex items-center justify-between cursor-pointer hover:bg-zinc-50 dark:hover:bg-zinc-900/50 transition-colors" onClick={() => toggleSection('preTax')}>
                                ...
                                {/* Taxes */}
                                <div className="border-b group">
                                    <div className="px-6 py-3 flex items-center justify-between cursor-pointer hover:bg-zinc-50 dark:hover:bg-zinc-900/50 transition-colors" onClick={() => toggleSection('taxes')}>
                                ...
                                {/* Post-Tax Deductions */}
                                <div className="border-b group">
                                    <div className="px-6 py-3 flex items-center justify-between cursor-pointer hover:bg-zinc-50 dark:hover:bg-zinc-900/50 transition-colors" onClick={() => toggleSection('postTax')}>
