...
import { Activity, Truck, AlertOctagon, TrendingUp } from "lucide-react";

export default function LogisticsDashboard() {
    const { data: dashboard = [], isLoading } = useQuery<any[]>({
        queryKey: ["/api/logistics-dashboard"],
        queryFn: () => fetch("/api/logistics-dashboard").then(r => r.json()).catch(() => []),
    });
    ...
    return (
        <StandardDashboard
            header={{
                ...
                description: "Executive summary, KPIs, fleet health, shipment tracking, alerts"
            }}
        >
