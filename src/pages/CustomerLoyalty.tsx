  ...
  return (
    ...
    >
      <div className="grid grid-cols-3 gap-4">
        ...
        <Card><CardContent className="pt-6"><p className="text-muted-foreground text-sm">Points Issued</p><p className="text-2xl font-bold">{formatNumber(totalPoints)}</p></CardContent></Card>
