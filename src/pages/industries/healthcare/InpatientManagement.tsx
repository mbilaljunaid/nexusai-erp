    ...
    <StandardPage title="Inpatient Management & Ward Operations">
      ...
      <Card data-testid="card-new-admit">
        ...
        <CardContent className="space-y-3">
          <div className="grid grid-cols-5 gap-2">
            ...
            <Button disabled={createMutation.isPending || !newAdmit.admissionId} size="sm" data-testid="button-admit">
      ...
      <Card>
        ...
        <CardContent className="space-y-2">
          {isLoading ? <TableSkeleton rows={4} /> : admissions.length === 0 ? <p className="text-muted-foreground text-center py-4">No admissions</p> : admissions.map((a: any) => (
            <div key={a.id} className="p-2 border rounded text-sm hover-elevate flex items-center justify-between" data-testid={`admit-${a.id}`}>
              ...
              <div className="flex gap-2 items-center">
                ...
                <Button size="icon" variant="ghost" data-testid={`button-delete-${a.id}`} className="h-7 w-7" aria-label="Delete">
