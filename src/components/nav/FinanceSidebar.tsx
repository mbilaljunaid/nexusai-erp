...
export const financeMenu = [
    ...
    },
    {
        ...
        items: [
            ...
            { title: "Add Asset", url: "/fixed-assets/add-asset", icon: Plus },
            ...
            { title: "Mass Additions", url: "/fixed-assets/mass-additions", icon: Layers },
            { title: "Group Assets", url: "/fixed-assets/group-assets", icon: Layers },
            { title: "Mass Change", url: "/fixed-assets/mass-change", icon: RefreshCw },
            { title: "What-If Analysis", url: "/fixed-assets/what-if", icon: BarChart3 },
            { title: "Depreciation Projection", url: "/fixed-assets/depreciation-projection", icon: TrendingDown },
            { title: "Impairment Testing", url: "/fixed-assets/impairment", icon: AlertCircle },
    ...
    },
    {
        ...
        items: [
            ...
            { title: "Subleases", url: "/leases/subleases", icon: Building2 },
            { title: "Initial Direct Costs", url: "/leases/initial-direct-costs", icon: DollarSign },
