...
export function ReconciliationSplitView({ bankAccountId }: ReconciliationSplitViewProps) {
    ...
    return (
        <div className="space-y-4">
            <div className="flex justify-between items-center bg-muted/50 p-4 rounded-lg sticky top-0 z-20 border shadow-sm">
                <div className="flex gap-8">
                    ...
                    <div className="border-l pl-8">
                        ...
                        <p className={`text-lg font-bold ${Math.abs(difference) < 0.01 ? "text-green-600" : "text-red-600"}`}>
