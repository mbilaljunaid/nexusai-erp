...
export function MetadataFormRenderer({
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-4">
      ...
      {/* Error message */}
      {formError && (
        <div className="bg-red-500/10 border border-red-200 text-red-800 p-4 rounded mb-4" data-testid="form-error">
          {formError}
        </div>
      )}
      ...
      {/* Success message */}
      {successMessage && (
        <div className="bg-green-500/10 border border-green-200 text-green-800 p-4 rounded mb-4" data-testid="form-success">
          {successMessage}
        </div>
      )}
