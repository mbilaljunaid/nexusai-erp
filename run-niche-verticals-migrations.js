#!/usr/bin/env node
/**
 * Niche Verticals Migration Runner
 * Runs all 12 niche vertical platform migrations
 */
...
async function main() {
    console.log('🚀 Niche Verticals Migration Runner\n');
    console.log('Database:', process.env.DATABASE_URL?.split('@')[1] || 'Unknown');
    console.log('='.repeat(70));

    const migrationsDir = path.join(__dirname, 'supabase', 'migrations');

    // All niche vertical migrations in order
    const migrations = [
    ...
    console.log(`\n📋 Migration Plan (${migrations.length} migrations covering 30 modules + prerequisites):\n`);
